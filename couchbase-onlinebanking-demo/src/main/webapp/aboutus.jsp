...
<head>
    ...
    <!-- 
	This is a sample of a standard page where only the right sidebar is included, leaving the a large
	left area clear for content use.
     -->
    ...
    <link href="citi/css/ie8fixes.css" rel="stylesheet" type="text/css" />
    <!--[if IE 6]>
            <link href="citi/css/ie6fixes.css" rel="stylesheet" type="text/css" />
        <![endif]-->
    <!--[if IE 7]>
            <link href="citi/css/ie7fixes.css" rel="stylesheet" type="text/css" />
        <![endif]-->
    <!--[if IE 8]>
            <link href="citi/css/ie8fixes.css" rel="stylesheet" type="text/css" />
        <![endif]-->
		...
		<!-- 
        Developers please reference the internal SiteCatalyst user guide on Brand Central for detailed implementation guidelines.
		 -->	
		
		<!-- ************* Search Taxonomy ************** -->
			<!-- Developers please reference the internal search taxonomy user guide and excel file on Brand Central for important information,
			including the values for the internal search tag taxonomy.
			-->
...
<div id="pagecontainer">
    <div id="wrapper">
                    ...
                    <div id="center_cont">
                        ...
                        <h1 class="logo">
                            <span class="brandCentral">
                                    <a class="interStateTitle" href="#"><img src="citi/images/top_title.png" alt="Internal Portal Name" title="Internal Portal Name"/></a>
                            </span>
                            ...
                            <%}else{ %>
     						...
     						<%} %>
                          	<form class="drop" id="loginform" action="login" method="post">
								<input type="hidden" name="index" id="index" value="aboutus"/>
        ...
        <div id="toolbar" class="toolbar_bg toolbar_noleft">
        ...
        <div id="content" class="content_bg content_noleft">
            <div class="col_2 col2_noleft" id="PageContentBlock">
                <div class="col_central">
                    <div class="breadcrumb">
                        &nbsp;</div>
                    <div class="col_2_content">
                        <h1 id="pagetitle" class="pagetitle">About Us</h1>
                      
                        <div class="clear-block">
                            <div class="heading_title">
                                Content Heading</div>
                            <div class="heading_desc" style="border: 0px;">
                            ...
                            <div id="body_content_right" class="tab_body_content">
                               <div class="tab_body_left">
                                    <div class="tabheading_img" title="Image description alt text" alt="Image description alt text"></div>
                                    <div class="sub_page_title"><a href="#" style="text-decoration:none;">Sub Page Link</a></div>
            ...
            <div class="col_3 col_right" id="RightNavBlock">
                <div class="col_3_bg">
                    <div class="ip_img">
                        <img src="citi/images/right_mon.png" alt="Image description alt text" title="Image description alt text" />
                        <p>
                            The Citi<sup>&reg;</sup> News app for iPad. A rich, interactive app that delivers the latest
                            Citi News</p>
                        <a class="btn_pcta" href="/" title="Promotional call to action">Promotional call to action</a>
                    </div>
                </div>
        ...
        <div id="footer" style="margin-top:-5px">
            <div class="nav_bar">
                <ul>
                    ...
                    <li>
						...
						Released: 12/17/2012. Compiled 12/17/2012 10:24:22 AM -0600
            ...
            <!--        <small class="copyright">
					<span class="left">Site legal copy here.</span>
	               	<span class="right">
					    <ul class="share">
						    <li><a href="#" target="_blank"><img id="img1" class="share_icon" src="citi/images/global_icon_1_0.jpg"/></a></li>
						    <li><a href="javascript:showFbModal();" id="a_facebook"><img id="img2" class="share_icon" src="citi/images/global_icon_2_0.jpg"/></a></li>
						    <li><a href="#" target="_blank"><img id="img3" class="share_icon" src="citi/images/global_icon_3_0.jpg"/></a></li>
						    <li><a href="#" target="_blank"><img id="img4" class="share_icon" src="citi/images/global_icon_4_0.jpg"></a></li>
						    <li><a href="#" target="_blank"><img id="img5" class="share_icon" src="citi/images/global_icon_5_0.jpg"></a></li>
					        <li><a href="#" target="_blank"><img id="img6" class="share_icon" src="citi/images/global_icon_6_0.jpg"></a></li>
					    </ul>						   
	                </span>
                 </small>-->
